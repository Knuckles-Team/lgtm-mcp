# Lgtm MCP Agent Specs

> Claude Code loads this file via `CLAUDE.md` (`@AGENTS.md` import) — the two stay
> in sync. Edit **this** file, not `CLAUDE.md`.

<!-- CONCEPT:LG-OS.governance.lgtm -->
<!-- CONCEPT:LG-OS.governance.lgtm-2 -->
<!-- CONCEPT:LG-OS.identity.lgtm -->
...
- **Key Files**:
  - `lgtm_mcp/mcp_server.py`: FastMCP entry points and tool registration.
  - `lgtm_mcp/api_client.py`: API facade inheriting from custom domain modules.
  - `lgtm_mcp/auth.py`: Credentials loading, credential validation, and authentication headers.
...
|------------|------|-------------|
| `CONCEPT:LG-OS.governance.lgtm` | Core API Client Operations | Dynamic API facade client integration |
| `CONCEPT:LG-OS.governance.lgtm-2` | FastMCP Tools Execution | FastMCP tool registration and stdio handling |
| `CONCEPT:LG-OS.identity.lgtm` | Identity & Gateway Security | Credential validation and SSL verification |
