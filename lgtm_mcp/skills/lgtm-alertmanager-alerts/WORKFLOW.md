...
| `LGTM_TLS_PROFILE` | optional | Named AgentConfig TLS profile; peer and hostname verification are mandatory. |
| `LGTM_TLS_PROFILE_REF` | optional | Reference-backed AgentConfig TLS profile selector. |
