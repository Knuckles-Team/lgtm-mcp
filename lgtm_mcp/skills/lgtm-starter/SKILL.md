...
name: lgtm-starter
description: >-
  Lgtm API + MCP Server + A2A Server Use when working with Lgtm via this package's MCP
...
Starter skill for the **Lgtm** package. Use the `mcp-client` universal skill
